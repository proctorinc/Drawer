...
func initProductionDB() (*sql.DB, error) {
	db, err := sql.Open("libsql", "file:drawer.db?cache=shared&_journal=WAL&_timeout=5000")
...
func initializeDevData(db *sql.DB) error {
	...
	demoData := `
		...
		INSERT OR IGNORE INTO users (id, username, email) VALUES 
			('user1', 'DemoUser1', 'demo1@example.com'),
			('user2', 'DemoUser2', 'demo2@example.com');
